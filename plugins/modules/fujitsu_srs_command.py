...
"""fujitsu_srs_command module.

Send commands to the remote node and return responses.
...
DOCUMENTATION = '''
---
module: fujitsu_srs_command
short_description: Run commands on remote devices running Fujitsu SR-S
version_added: 2.9
description:
  - Sends arbitrary commands to an fujitsu sr-s switch.
options:
  commands:
    description:
