...
DOCUMENTATION = """
---
module: fujitsu_srs_config
version_added: "2.9"
author: "Takamitsu IIDA (@takamitsu-iida)"
short_description: Run config commands on remote devices running Fujitsu SR-S
description:
  - Sends arbitrary config commands to SR-S node.
options:
  lines:
    description:
...
from ansible.module_utils.fujitsu_srs import edit_config
